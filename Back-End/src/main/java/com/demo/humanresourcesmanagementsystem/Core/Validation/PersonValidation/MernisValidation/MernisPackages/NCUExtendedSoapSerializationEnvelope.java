...
public class NCUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NCUDateTimeConverter converter) {
        if (converter == null) {
            dateTimeConverter = new NCUStandardDateTimeConverter();
        }
        dateTimeConverter = converter;
    }

    public static NCUDateTimeConverter getDateTimeConverter() {
        return dateTimeConverter;
    }

    private static NCUDateTimeConverter dateTimeConverter = new NCUStandardDateTimeConverter();

    public NCUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NCUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NCUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null) {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector) && type.type != java.lang.String.class)) {
                java.lang.String xmlName = NCUHelper.getKeyByValue(classNames, obj.getClass());
                if (xmlName != null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap", Object.class, NCUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param) {
        ...
        java.lang.String xmlName = NCUHelper.getKeyByValue(classNames, obj);
        if (xmlName == null) {
            return obj;
        }
        return xmlName;
