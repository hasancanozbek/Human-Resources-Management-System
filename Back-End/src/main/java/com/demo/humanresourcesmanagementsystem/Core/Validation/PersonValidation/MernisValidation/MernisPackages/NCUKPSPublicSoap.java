...
public class NCUKPSPublicSoap {
    ...
    public NCUKPSPublicSoap() {
    }

    public NCUKPSPublicSoap(String url) {
        this.url = url;
    }

    public NCUKPSPublicSoap(String url, int timeOut) {
        this.url = url;
    ...
    protected NCUExtendedSoapSerializationEnvelope createEnvelope() {
        NCUExtendedSoapSerializationEnvelope envelope = new NCUExtendedSoapSerializationEnvelope(NCUExtendedSoapSerializationEnvelope.VER11);
