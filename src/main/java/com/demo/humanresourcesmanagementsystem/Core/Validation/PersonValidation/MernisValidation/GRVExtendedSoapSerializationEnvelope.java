...
public class GRVExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(GRVDateTimeConverter converter) {
        if (converter == null) {
            dateTimeConverter = new GRVStandardDateTimeConverter();
        }
        dateTimeConverter = converter;
    }

    public static GRVDateTimeConverter getDateTimeConverter() {
        return dateTimeConverter;
    }

    private static GRVDateTimeConverter dateTimeConverter = new GRVStandardDateTimeConverter();

    public GRVExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public GRVExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new GRVMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null) {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector) && type.type != java.lang.String.class)) {
                java.lang.String xmlName = GRVHelper.getKeyByValue(classNames, obj.getClass());
                if (xmlName != null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap", Object.class, GRVExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param) {
        ...
        java.lang.String xmlName = GRVHelper.getKeyByValue(classNames, obj);
        if (xmlName == null) {
            return obj;
        }
        return xmlName;
