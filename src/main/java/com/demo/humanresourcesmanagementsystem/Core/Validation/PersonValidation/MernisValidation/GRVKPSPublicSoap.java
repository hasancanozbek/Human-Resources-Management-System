...
public class GRVKPSPublicSoap {
    ...
    public GRVKPSPublicSoap() {
    }

    public GRVKPSPublicSoap(String url) {
        this.url = url;
    }

    public GRVKPSPublicSoap(String url, int timeOut) {
        this.url = url;
    ...
    protected GRVExtendedSoapSerializationEnvelope createEnvelope() {
        GRVExtendedSoapSerializationEnvelope envelope = new GRVExtendedSoapSerializationEnvelope(GRVExtendedSoapSerializationEnvelope.VER11);
