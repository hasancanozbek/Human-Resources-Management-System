package com.demo.humanresourcesmanagementsystem.Core.Validation.PersonValidation.MernisValidation.MernisPackages;
...
public class NCUKPSPublicSoap12 {
    interface NCUIWcfMethod {
        NCUExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(NCUExtendedSoapSerializationEnvelope __envelope, java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public NCUKPSPublicSoap12() {
    }

    public NCUKPSPublicSoap12(String url) {
        this.url = url;
    }

    public NCUKPSPublicSoap12(String url, int timeOut) {
        this.url = url;
    ...
    protected NCUExtendedSoapSerializationEnvelope createEnvelope() {
        NCUExtendedSoapSerializationEnvelope envelope = new NCUExtendedSoapSerializationEnvelope(NCUExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;

        return envelope;
    }

    protected java.util.List sendRequest(String methodName, NCUExtendedSoapSerializationEnvelope envelope, org.ksoap2.transport.Transport transport, com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception {
    ...
    java.lang.Object getResult(java.lang.Class destObj, java.lang.Object source, String resultName, NCUExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception {
        if (source == null) {
            return null;
        }
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo, final String Ad, final String Soyad, final Integer DogumYili) throws java.lang.Exception {
        ...
        return (Boolean) execute(new NCUIWcfMethod() {
            @Override
            public NCUExtendedSoapSerializationEnvelope CreateSoapEnvelope() {
                NCUExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(NCUExtendedSoapSerializationEnvelope __envelope, java.lang.Object __result) throws java.lang.Exception {
    ...
    protected java.lang.Object execute(NCUIWcfMethod wcfMethod, String methodName, com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception {
        org.ksoap2.transport.Transport __httpTransport = createTransport();
        __httpTransport.debug = enableLogging;
        NCUExtendedSoapSerializationEnvelope __envelope = wcfMethod.CreateSoapEnvelope();
        try {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault, NCUExtendedSoapSerializationEnvelope envelope) {
